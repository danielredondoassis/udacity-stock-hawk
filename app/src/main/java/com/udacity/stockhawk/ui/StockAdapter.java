...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    void setCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            if(count > mRefCount && mRefCount != 0) Toast.makeText(context, "Ação Adicionada com Sucesso", Toast.LENGTH_SHORT).show();
        }
    ...
    class StockViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            newIntent.putExtra(Contract.Quote.COLUMN_SYMBOL,cursor.getString(Contract.Quote.POSITION_SYMBOL));
